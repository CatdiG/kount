...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 sm:py-8 flex flex-col items-center justify-start selection:bg-indigo-500 selection:text-white font-sans">
      ...
      <main className="w-full sm:max-w-2xl bg-slate-50 min-h-screen sm:min-h-0 sm:rounded-3xl border border-slate-200 shadow-xl overflow-hidden flex flex-col relative -mt-[10px]">
        {/* 1. Header Bar */}
        ...
        {!isLoading && isUserUploaded && parsingResult && (
          <div className="space-y-3 pt-[9px]">
            ...
            {/* Footer */}
            <footer className="py-4 -mt-[10px] text-center text-xs text-slate-400 font-medium flex items-center justify-center gap-1.5">
